...
public class SkillEffectData_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/ExcelData/SkillEffectData.xls";
	private static readonly string exportPath = "Assets/ExcelData/SkillEffectData.asset";
